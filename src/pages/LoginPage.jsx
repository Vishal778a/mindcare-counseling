...
export default function LoginPage() {
  const { loginAsAdmin, loginAsPatient, isAuthenticated, isAdmin } = useAuth();
  ...
  return (
    <div className="login-page animate-fade-in">
      <div className="card card-glass login-card animate-scale-in">
        ...
        {/* Google Sign-In Button (Visual — will be connected to real OAuth later) */}
        <button
